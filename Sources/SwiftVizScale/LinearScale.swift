...
public enum LinearScale {
    ...
    public struct DoubletoDoubleScale: TickScale {
        ...
        public typealias InputType = Double
        /// The type used for the scale's range.
        public typealias OutputType = Double
    ...
    ///   - low: The lower bounds of the domain.
    ///   - high: The upper bounds of the domain.
    public static func create(_ low: Float, _ high: Float) -> LinearScale.FloatToFloatScale {
        LinearScale.FloatToFloatScale(from: low, to: high)
    }

    /// Creates a linear scale that maps values within the range you provide.
    /// - Parameter range: The range of the domain.
    public static func create(_ range: ClosedRange<Float>) -> LinearScale.FloatToFloatScale {
        LinearScale.FloatToFloatScale(from: range.lowerBound, to: range.upperBound)
    }

    /// Creates a linear scale that maps values from 0 to the upper bound you provide.
    /// - Parameter high: The upper bounds of the domain.
    public static func create(_ high: Float) -> LinearScale.FloatToFloatScale {
    ...
    ///   - low: The lower bounds of the domain.
    ///   - high: The upper bounds of the domain.
    public static func create(_ low: Int, _ high: Int) -> LinearScale.IntToFloatScale {
        LinearScale.IntToFloatScale(from: low, to: high)
    }

    /// Creates a linear scale that maps values from 0 to the upper bound you provide.
    /// - Parameter high: The upper bounds of the domain.
    public static func create(_ high: Int) -> LinearScale.IntToFloatScale {
        LinearScale.IntToFloatScale(from: 0, to: high)
    }

    /// Creates a linear scale that maps values within the range you provide.
    /// - Parameter range: The range of the domain.
    public static func create(_ range: ClosedRange<Int>) -> LinearScale.IntToFloatScale {
        LinearScale.IntToFloatScale(from: range.lowerBound, to: range.upperBound)
    }
}
