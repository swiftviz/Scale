...
public enum PowerScale {
    ...
    public static func create(_ low: Double, _ high: Double, exponent: Double) -> PowerScale.DoubleScale {
        PowerScale.DoubleScale(from: low, to: high, exponent: exponent)
    }
    ...
    public static func create(_ range: ClosedRange<Double>, exponent: Double) -> PowerScale.DoubleScale {
        PowerScale.DoubleScale(from: range.lowerBound, to: range.upperBound, exponent: exponent)
    }
    ...
    /// - Parameter exponent: The exponent for the power transform.
    public static func create(_ high: Double, exponent: Double) -> PowerScale.DoubleScale {
        PowerScale.DoubleScale(from: 0, to: high, exponent: exponent)
    }
}
