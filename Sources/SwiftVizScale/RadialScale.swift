...
public struct RadialScale<InputType: ConvertibleWithDouble & NiceValue, OutputType: ConvertibleWithDouble>: ContinuousScaleProtocol {
    ...
    /// - Returns: A copy of the scale with the domain values you provide.
    public func domain(_ values: [InputType], nice: Bool) -> RadialScale<InputType, OutputType> {
